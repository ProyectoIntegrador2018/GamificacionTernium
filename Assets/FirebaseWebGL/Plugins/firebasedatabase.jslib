mergeInto(LibraryManager.library, {
    ...
    GetUsers: function(objectName, callback, fallback) {
        var path = 'users';
        var parsedObjectName = Pointer_stringify(objectName);
        var parsedCallback = Pointer_stringify(callback);
        var parsedFallback = Pointer_stringify(fallback);
    ...
    GetEvents: function(objectName, callback, fallback) {
        var path = 'events';
        var parsedObjectName = Pointer_stringify(objectName);
        var parsedCallback = Pointer_stringify(callback);
        var parsedFallback = Pointer_stringify(fallback);
    ...
    PushJSON: function(path, value, objectName, callback, fallback) {
        ...
        try {
            ...
            firebase.database().ref(parsedPath).push().set({author: parsedValue, title: parsedValue}).then(function(unused) {
    ...
    PushUser: function(username, password, objectName, callback, fallback) {
        var path = "users";
        var parsedUsername = Pointer_stringify(username);
        var parsedPass = Pointer_stringify(password);
        var parsedObjectName = Pointer_stringify(objectName);
        var parsedCallback = Pointer_stringify(callback);
        var parsedFallback = Pointer_stringify(fallback);
        ...
        try {
            ...
            "started": [
                ...
                unityInstance.Module.SendMessage(parsedObjectName, parsedCallback, "Success");
            });
    ...
    PushAdmin: function(username, password, objectName, callback, fallback) {
        var path = "users";
        var parsedUsername = Pointer_stringify(username);
        var parsedPass = Pointer_stringify(password);
        var parsedObjectName = Pointer_stringify(objectName);
    ...
    PushEvent: function(title, description, date, objectName, callback, fallback) {
        var path = "events";
        var parsedTitle = Pointer_stringify(title);
        var parsedDescription = Pointer_stringify(description);
        var parsedDate = Pointer_stringify(date);
        var parsedObjectName = Pointer_stringify(objectName);
        var parsedCallback = Pointer_stringify(callback);
        var parsedFallback = Pointer_stringify(fallback);
